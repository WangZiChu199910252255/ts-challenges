...
// type NewArrByLength<L extends number,arr extends number[] = []> = arr['length'] extends L ? arr : NewArrByLength<L,[...arr,arr['length']]>
// type NumberRange<L extends number, H extends number,arr extends number[] = NewArrByLength<L>> = arr['length'] extends H ? H : arr['length'] | NumberRange<L,H,[...arr,arr['length']]>
type test = NumberRange<0, 10>
